    ...
    <div className="max-w-6xl mx-auto px-4 pb-24">
      ...
      <section className="text-center pt-12 pb-14 space-y-5">
        ...
        <p className="text-gray-400 text-lg md:text-xl max-w-xl mx-auto leading-relaxed">
          Raccogliamo ogni giorno il meglio degli eventi così da non perderti niente.
          <br className="hidden md:block" />
          Non vedi il tuo evento? Proponicelo nella sezione <a href="/login" className="text-fuchsia-400 hover:text-fuchsia-300"></a>login.
        </p>
      </section>
